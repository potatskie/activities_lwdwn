...
class cmb_Meta_Box {
	...
	function show() {
		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			$meta = get_post_meta( get_the_ID(), $field['id'], 'multicheck' != $field['type'] /* If multicheck this can be multiple values */ );
			...
			switch ( $field['type'] ) {
				...
				case 'taxonomy_select':
					echo '<select name="', $field['id'], '" id="', $field['id'], '">';
					$names= wp_get_object_terms( get_the_ID(), $field['taxonomy'] );
				...
				case 'file':
					...
					echo '<input class="cmb_upload_button button" type="button" value="Upload File" />';
					echo '<input class="cmb_upload_file_id" type="hidden" id="', $field['id'], '_id" name="', $field['id'], '_id" value="', get_post_meta( get_the_ID(), $field['id'] . "_id",true), '" />';
					echo '<p class="cmb_metabox_description">', $field['desc'], '</p>';
