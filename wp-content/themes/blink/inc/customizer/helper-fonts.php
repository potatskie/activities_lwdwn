...
function blink_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'blink' ),
		'cyrillic'     => __( 'Cyrillic', 'blink' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'blink' ),
		'devanagari'   => __( 'Devanagari', 'blink' ),
		'greek'        => __( 'Greek', 'blink' ),
		'greek-ext'    => __( 'Greek Extended', 'blink' ),
		'khmer'        => __( 'Khmer', 'blink' ),
		'latin'        => __( 'Latin', 'blink' ),
		'latin-ext'    => __( 'Latin Extended', 'blink' ),
		'vietnamese'   => __( 'Vietnamese', 'blink' )
	);
}
endif;
 ...
 *
 * 696 fonts, updated on 3rd March, 2015.
 *
 * @since  1.0.0.
 *
...
function blink_get_google_fonts() {
	return apply_filters( 'blink_get_google_fonts', array(
		...
		'Andika' => array(
			'label' 	=> 'Andika',
			'variants' 	=> array( 'regular' ),
			'subsets' 	=> array( 'latin-ext', 'cyrillic', 'latin', 'cyrillic-ext' ),
			'category' 	=> 'sans-serif',
		),
		'Angkor' => array(
			'label' 	=> 'Angkor',
		...
		'Anonymous Pro' => array(
			'label' 	=> 'Anonymous Pro',
			'variants' 	=> array( 'regular', 'italic', '700', '700italic' ),
			'subsets' 	=> array( 'greek', 'latin-ext', 'cyrillic', 'latin' ),
			'category' 	=> 'monospace',
		),
		'Antic' => array(
			'label' 	=> 'Antic',
		...
		'Arimo' => array(
			'label' 	=> 'Arimo',
			'variants' 	=> array( 'regular', 'italic', '700', '700italic' ),
			'subsets' 	=> array( 'greek', 'latin-ext', 'cyrillic', 'vietnamese', 'greek-ext', 'latin', 'cyrillic-ext' ),
			'category' 	=> 'sans-serif',
		),
		'Arizonia' => array(
			'label' 	=> 'Arizonia',
		...
		'Comfortaa' => array(
			'label' 	=> 'Comfortaa',
			'variants' 	=> array( '300', 'regular', '700' ),
			'subsets' 	=> array( 'greek', 'latin-ext', 'cyrillic', 'latin', 'cyrillic-ext' ),
			'category' 	=> 'display',
		),
		'Coming Soon' => array(
			'label' 	=> 'Coming Soon',
		...
		'Didact Gothic' => array(
			'label' 	=> 'Didact Gothic',
			'variants' 	=> array( 'regular' ),
			'subsets' 	=> array( 'greek', 'latin-ext', 'cyrillic', 'greek-ext', 'latin', 'cyrillic-ext' ),
			'category' 	=> 'sans-serif',
		),
		'Diplomata' => array(
			'label' 	=> 'Diplomata',
		...
		'EB Garamond' => array(
			'label' 	=> 'EB Garamond',
			'variants' 	=> array( 'regular' ),
			'subsets' 	=> array( 'latin-ext', 'cyrillic', 'vietnamese', 'latin', 'cyrillic-ext' ),
			'category' 	=> 'serif',
		),
		'Eagle Lake' => array(
			'label' 	=> 'Eagle Lake',
		...
		'Noto Sans' => array(
			'label' 	=> 'Noto Sans',
			'variants' 	=> array( 'regular', 'italic', '700', '700italic' ),
			'subsets' 	=> array( 'greek', 'latin-ext', 'cyrillic', 'vietnamese', 'greek-ext', 'latin', 'devanagari', 'cyrillic-ext' ),
			'category' 	=> 'sans-serif',
		),
		'Noto Serif' => array(
			'label' 	=> 'Noto Serif',
