...
class Blink_CSS {
	...
	/**
	 * The one instance of Blink_CSS.
	 *
	 * @since 1.0.0.
	 *
	 * @var   Blink_CSS    The one instance for the singleton.
	 */
	...
	/**
	 * Instantiate or return the one Blink_CSS instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return Blink_CSS
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `blink_get_css->add()`. Because every property value has
...
if ( ! function_exists( 'blink_get_css' ) ) :
/**
 * Return the one Blink_CSS object.
 *
 * @since  1.0.0.
 *
 * @return Blink_CSS    The one Blink_CSS object.
 */
function blink_get_css() {
	return Blink_CSS::instance();
}
endif;

add_action( 'init', 'blink_get_css', 1 );
